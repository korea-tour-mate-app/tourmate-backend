        ...
        http
                .authorizeRequests(authorizeRequests ->
                        authorizeRequests
                                ...
                                .requestMatchers("/api/auth/**", "/api/s3/test", "/api/place/{placeId}/reviews", "/api/google-api/getTopRestaurantPlaces","/api/google-api/getRestaurantReviews", "/api/restaurants/**").permitAll() // /api/auth/signup URL에 대한 접근 허용
